...
\begin{resume}
  ...
  \section{SKILLSET\\SUMMARY}
          {\bf \emph{Languages}:} Shell, C, C++, Lua, Java, Javascript, Python, Perl\\ %PHP, XML
          %{\bf \emph{Libraries}:} MPI, STL, GSL, HDF4/5, NetCDF \\
          %{\bf \emph{Protocols}:} AMQP, MQTT, HTTP, TCP, UDP, SOAP \\
          {\bf \emph{Software}:} Docker, Kubernetes, Linux, Apache, MongoDB, SQL, GNU toolchain \\ %, \LaTeX
          %{\bf \emph{Operating Systems}:} *NIX, OSX, Windows
